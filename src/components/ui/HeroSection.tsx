...
export default function HeroSection() {
    return (
        <section id='home' className="max-h-[80dvh] overflow-y-hidden px-6 lg:px-16 flex h-dvh md:flex-row  items-center lg:justify-between gap-8">
            <div className="flex flex-col gap-6 text-zinc-900">
                ...
                >
                    <a
                        ...
                        href="#contact"
                        className='flex items-center justify-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-xl transition hover:bg-zinc-800 cursor-pointer'
                    >
            ...
            >
                <img
                    className=" w-[300px] sm:w-[250px] object-cover"
                    src='hero.webp'
