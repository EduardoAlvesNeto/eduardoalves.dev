...
export default function HeroSection() {
  return (
    <section id='home' className="max-h-[80dvh] overflow-y-hidden px-6 lg:px-16 flex h-dvh md:flex-row  items-center justify-center lg:justify-between gap-8 bg-zinc-100 dark:bg-zinc-900 transition-colors duration-400 ease-in-out">
      <div className="flex flex-col gap-6 text-zinc-900 dark:text-zinc-100">
        ...
        >
          ...
          <p className="text-zinc-600 text-base lg:text-lg font-medium text-center md:text-start">
